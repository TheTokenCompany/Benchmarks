...
MODEL_VOL_PATH = os.getenv("MODEL_VOL_PATH", "exp-20260724-235135-focus-grpo/best")
MODEL_ALIAS = os.getenv("MODEL_ALIAS", "bear-v7.2-focus")
AGGRESSIVENESS_LEVELS = [0.3, 0.5, 0.7]
VARIANTS = ["plain", "safenum", "safetab"]

app = modal.App("financebench-precompress-v72")
train_volume = modal.Volume.from_name("scratch-compression-training-v7.2-focus-rl")
...
def compress_all(texts: list[str], questions: list[str], text_ids: list[str],
                 model_vol_path: str = None, model_alias: str = None) -> dict:
    import re
    import time
    ...
    def infer_probs(question, line_words_per_text):
        ...
        q_ids = tokenizer(question, add_special_tokens=False)["input_ids"][:128]
